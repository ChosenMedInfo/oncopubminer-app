 ...
 */
package com.cn.xiaonuo.modular.libraries.enums;
...
public enum LibrariesExceptionEnum implements AbstractBaseExceptionEnum {
	...
	private final String message;
		LibrariesExceptionEnum(Integer code, String message) {
		this.code = code;
