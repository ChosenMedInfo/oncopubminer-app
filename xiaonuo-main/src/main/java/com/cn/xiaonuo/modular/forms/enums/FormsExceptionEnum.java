 ...
 */
package com.cn.xiaonuo.modular.forms.enums;
...
public enum FormsExceptionEnum implements AbstractBaseExceptionEnum {
	...
	private final String message;
		FormsExceptionEnum(Integer code, String message) {
		this.code = code;
