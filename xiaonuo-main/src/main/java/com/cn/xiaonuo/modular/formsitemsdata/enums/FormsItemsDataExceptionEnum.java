 ...
 */
package com.cn.xiaonuo.modular.formsitemsdata.enums;
...
public enum FormsItemsDataExceptionEnum implements AbstractBaseExceptionEnum {
	...
	private final String message;
		FormsItemsDataExceptionEnum(Integer code, String message) {
		this.code = code;
