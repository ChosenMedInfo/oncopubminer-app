 ...
 */
package com.cn.xiaonuo.modular.publications.enums;
...
public enum PublicationsExceptionEnum implements AbstractBaseExceptionEnum {
	...
	private final String message;
		PublicationsExceptionEnum(Integer code, String message) {
		this.code = code;
