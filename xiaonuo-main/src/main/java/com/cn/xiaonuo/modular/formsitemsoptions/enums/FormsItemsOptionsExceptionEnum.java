 ...
 */
package com.cn.xiaonuo.modular.formsitemsoptions.enums;
...
public enum FormsItemsOptionsExceptionEnum implements AbstractBaseExceptionEnum {
	...
	private final String message;
		FormsItemsOptionsExceptionEnum(Integer code, String message) {
		this.code = code;
