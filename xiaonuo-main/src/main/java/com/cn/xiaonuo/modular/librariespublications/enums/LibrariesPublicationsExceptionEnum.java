 ...
 */
package com.cn.xiaonuo.modular.librariespublications.enums;
...
public enum LibrariesPublicationsExceptionEnum implements AbstractBaseExceptionEnum {
	...
	private final String message;
		LibrariesPublicationsExceptionEnum(Integer code, String message) {
		this.code = code;
