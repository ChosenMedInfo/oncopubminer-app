 ...
 */
package com.cn.xiaonuo.modular.funcsuggest.enums;
...
public enum FuncSuggestExceptionEnum implements AbstractBaseExceptionEnum {
	...
	private final String message;
		FuncSuggestExceptionEnum(Integer code, String message) {
		this.code = code;
