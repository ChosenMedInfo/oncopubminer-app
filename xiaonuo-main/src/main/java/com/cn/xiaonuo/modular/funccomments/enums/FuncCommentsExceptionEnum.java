 ...
 */
package com.cn.xiaonuo.modular.funccomments.enums;
...
public enum FuncCommentsExceptionEnum implements AbstractBaseExceptionEnum {
	...
	private final String message;
		FuncCommentsExceptionEnum(Integer code, String message) {
		this.code = code;
