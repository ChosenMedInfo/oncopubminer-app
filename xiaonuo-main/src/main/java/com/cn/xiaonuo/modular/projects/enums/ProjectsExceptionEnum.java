 ...
 */
package com.cn.xiaonuo.modular.projects.enums;
...
public enum ProjectsExceptionEnum implements AbstractBaseExceptionEnum {
	...
	private final String message;
		ProjectsExceptionEnum(Integer code, String message) {
		this.code = code;
