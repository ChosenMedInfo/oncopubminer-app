 ...
 */
package com.cn.xiaonuo.modular.projectpubstatus.enums;
...
public enum ProjectPubStatusExceptionEnum implements AbstractBaseExceptionEnum {
	...
	private final String message;
		ProjectPubStatusExceptionEnum(Integer code, String message) {
		this.code = code;
