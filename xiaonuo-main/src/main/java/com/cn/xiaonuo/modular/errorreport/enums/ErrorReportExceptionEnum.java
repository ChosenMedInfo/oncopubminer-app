 ...
 */
package com.cn.xiaonuo.modular.errorreport.enums;
...
public enum ErrorReportExceptionEnum implements AbstractBaseExceptionEnum {
	...
	private final String message;
		ErrorReportExceptionEnum(Integer code, String message) {
		this.code = code;
