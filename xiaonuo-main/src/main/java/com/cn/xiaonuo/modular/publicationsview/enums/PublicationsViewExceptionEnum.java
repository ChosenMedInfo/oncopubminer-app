 ...
 */
package com.cn.xiaonuo.modular.publicationsview.enums;
...
public enum PublicationsViewExceptionEnum implements AbstractBaseExceptionEnum {
	...
	private final String message;
		PublicationsViewExceptionEnum(Integer code, String message) {
		this.code = code;
