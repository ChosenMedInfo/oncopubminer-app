...
public interface SysFileInfoService extends IService<SysFileInfo> {
     ...
     */
    void previewAbsoluteImg(SysFileInfoParam sysFileInfoParam, HttpServletResponse response);
     ...
     */
    void previewAbsolutePdf(SysFileInfoParam sysFileInfoParam, HttpServletResponse response);
