...
public class SysNoticeController {
	...
	/**
	 * @desc   查看系统通知公告之用户阅读信息
	 * @desc   备注：此方法没有实际作用，纯粹为了前端添加权限用！
	 * @author quanxu
	 * @date   2021-06-17 14:35
	 */
	@Permission
	@ResponseBody
	@GetMapping("/sysNoticeUser/detail")
	@BusinessLog(title = "系统通知公告_阅读信息查看", opType = LogAnnotionOpTypeEnum.DETAIL)
	public ResponseData readDetail(@Validated(SysNoticeParam.detail.class) SysNoticeParam sysNoticeParam) {
		return new SuccessResponseData(sysNoticeService.detail(sysNoticeParam));
	}
