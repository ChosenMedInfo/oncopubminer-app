...
public interface SysUserService extends IService<SysUser> {
     ...
     * @date 2021-09-14
     */
    PageResult<SysUserResult> pageMember(SysUserParam sysUserParam);
     ...
     * @date 2020/4/14 9:21
     */
    List<SysUser> listMember(SysUserParam sysUserParam);
     ...
     **/
    void checkLoginAndAutoRegisterAndAutoLogin(HttpServletRequest request);
