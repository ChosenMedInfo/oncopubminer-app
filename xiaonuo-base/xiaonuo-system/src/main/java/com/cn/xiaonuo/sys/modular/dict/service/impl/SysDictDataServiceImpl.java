...
public class SysDictDataServiceImpl extends ServiceImpl<SysDictDataMapper, SysDictData> implements SysDictDataService {
	...
	/**
	 * @desc 根据字典类型以及字典编码，获取字典的值
	 *
	 * @author quanxu
	 * @date 2021-05-10 17:21
	 */
	@Override
	public String getDictValueByDictTypeCodeAndDictCode(String dictTypeCode, String dictCode) {
		return this.baseMapper.getDictValueByDictTypeCodeAndDictCode(dictTypeCode, dictCode);
	}
}
