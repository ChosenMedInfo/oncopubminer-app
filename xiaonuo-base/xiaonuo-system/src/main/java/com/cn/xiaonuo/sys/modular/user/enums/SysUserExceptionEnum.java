...
public enum SysUserExceptionEnum implements AbstractBaseExceptionEnum {
     ...
     * 账号已存在
     */
    USER_ACCOUNT_REPEAT(2, "Account already exists, please check the account parameter!"),

    /**
     * 原密码错误
     */
    USER_PWD_ERROR(3, "Current password error!"),

    /**
     * 新密码与原密码相同
     */
    USER_PWD_REPEAT(4, "New password is the same with current password, please change it!"),

    /**
     * 不能删除超级管理员
     */
    USER_CAN_NOT_DELETE_ADMIN(5, "Super administrator cannot be deleted!"),

    /**
     * 不能修改超级管理员状态
     */
    USER_CAN_NOT_UPDATE_ADMIN(6, "Super administrator status cannot be modified!");
