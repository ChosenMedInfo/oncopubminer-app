...
public class SysFileInfoController {
	...
	public Dict upload(@RequestPart("file") MultipartFile file) {
		...
		dict.put("filePath", sysFileInfo.getFilePath());
		dict.put("fileSize", sysFileInfo.getFileSizeInfo());
		return dict;
	}
	 ...
	 */
	@ResponseBody
	@GetMapping("/sysFileInfo/previewAbsoluteImg")
	public void previewAbsoluteImg(@Validated(SysFileInfoParam.detail.class) SysFileInfoParam sysFileInfoParam, HttpServletResponse response) {
		sysFileInfoService.previewAbsoluteImg(sysFileInfoParam, response);
	}
     ...
     *
     * @author quanxu
     * @date 2021-04-08 16:46
     */
	@ResponseBody
	@GetMapping("/sysFileInfo/previewAbsolutePdf")
	public void previewAbsolutePdf(@Validated(SysFileInfoParam.detail.class) SysFileInfoParam sysFileInfoParam, HttpServletResponse response) {
		sysFileInfoService.previewAbsolutePdf(sysFileInfoParam, response);
	}
     ...
     */
	@ResponseBody
	@GetMapping("/sysFileInfo/searchFile")
	public void searchFile(@Validated(SysFileInfoParam.detail.class) SysFileInfoParam sysFileInfoParam, HttpServletResponse response) {
		sysFileInfoService.previewAbsolutePdf(sysFileInfoParam, response);
	}
